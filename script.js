$(document).ready(function () {
    let deck = [
        ...
        { value: "2", shortValue: "2", suit: "club", shortSuit: "♣", price: 2 },
        { value: "3", shortValue: "3", suit: "club", shortSuit: "♣", price: 3 },
        { value: "4", shortValue: "4", suit: "club", shortSuit: "♣", price: 4 },
        { value: "5", shortValue: "5", suit: "club", shortSuit: "♣", price: 5 },
        { value: "6", shortValue: "6", suit: "club", shortSuit: "♣", price: 6 },
        { value: "7", shortValue: "7", suit: "club", shortSuit: "♣", price: 7 },
        { value: "8", shortValue: "8", suit: "club", shortSuit: "♣", price: 8 },
        { value: "9", shortValue: "9", suit: "club", shortSuit: "♣", price: 9 },
        {
            value: "10",
            shortValue: "10",
            suit: "club",
    ...
    deck = deck.map((card) => ({ ...card, isFlipped: false }));
    ...
    $(".shuffle").click(function (e) {
        ...
        deck.forEach((card) => {
            $(".table").append(generateCard(card));
        });
    });
